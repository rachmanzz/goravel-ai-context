...
**Note**: Session entry, context loading priority, and re-entry for existing projects are handled by `.ai/context/entry.md`.
...
A clarification file is considered **incomplete** if:
- Required fields are missing or empty
- Answers contain placeholders (e.g., `{{your-value}}`, `...`)
- Answers are marked as `TBD`, `TODO`, or `unknown`
...
## 8. Install Required Stack Libraries
